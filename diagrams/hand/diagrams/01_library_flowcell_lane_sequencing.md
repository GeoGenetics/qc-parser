# Library, flowcell lane, sequencing read, and FASTQ file
...
Interpretation: paired-end sequencing produces two sequencing-read records, R1 and R2, for each library–lane combination.
