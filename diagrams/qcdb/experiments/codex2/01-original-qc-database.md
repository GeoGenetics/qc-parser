# 1. Original QC database structure

This represents the relationships initially inferred from the SQL dump.
...
`AUDIT_LOG` is not connected by a foreign key; audit records are created through triggers.
