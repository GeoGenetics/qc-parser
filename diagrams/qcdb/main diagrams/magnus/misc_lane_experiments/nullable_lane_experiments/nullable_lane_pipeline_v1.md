...
erDiagram
    ...
    STAT_FILE {
        int lookup_id PK
        string read_type "R1, R2, collapsed, singleton, sequencing_output"  
        string processing_type "seqkit/derep, merge_lanes, demultiplex"
        string stat_tool "fastqc, nonpareil, derep, demultiplex, merge_lanes"
    }
